...
FILES.push('./CONFLICT-REGISTER.md','./conflict-register.json','./expedition-accounts.json','./CURRENT-CONTINUITY.md','./DROSSANE-INCIDENT.md','./EXPEDITION-RETURN.md','./ROYAL-COMMISSION.md','./population-current.json');
