...
const FILES=['./','./index.html','./manifest.webmanifest','./sigil-v1.png','./sigil-gold-clear.png','./portrait.png','./ECONOMIC-REFERENCE.md','./ESTATE-ACCOUNTS.md','./PHYSIOLOGY-REFERENCE.md'];
