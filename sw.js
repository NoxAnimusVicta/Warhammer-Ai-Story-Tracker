...
const FILES=['./','./index.html','./manifest.webmanifest','./sigil-v1.png','./sigil-gold-clear.png','./portrait.png','./portrait-expedition-r50.jpg','./APPEARANCE-REFERENCE.md','./ECONOMIC-REFERENCE.md','./ESTATE-ACCOUNTS.md','./PHYSIOLOGY-REFERENCE.md','./TRANSPORT-REFERENCE.md','./ESTATE-REFERENCE.md','./estate-r48.jpg'];
